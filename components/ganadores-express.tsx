        ...
        <div className="max-w-3xl mx-auto space-y-2.5">
          {ganadores.map((ganador, index) => (
            <Reveal key={ganador.id} delay={Math.min(index, 5) * 70}>
              <div className="card-brand-soft px-4 py-3 md:px-6 md:py-4 flex items-center justify-between gap-3">
                {/* Número */}
                <div className="chip-brand rounded-lg px-3 py-2 flex-shrink-0 min-w-[60px] text-center">
                ...
                <div className="flex-1 text-center">
                  <p className="text-brand-copy font-semibold text-sm md:text-base">
