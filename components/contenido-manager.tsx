...
const SECCIONES: Seccion[] = [
  ...
  },
  {
    ...
    descripcion:
      "Textos del contador regresivo. Sólo se muestran si cargaste una fecha de cierre en 'Fechas y cierre de ventas'.",
    campos: [
      { key: "cierre_kicker", label: "Título arriba del contador" },
      {
        key: "cierre_sorteo_label",
        label: "Línea con la fecha del sorteo",
        ayuda: "Usá {fecha} donde quieras que aparezca la fecha y hora del sorteo",
      },
      { key: "cierre_cerrado_titulo", label: "Título cuando cerraron las ventas" },
      {
        key: "cierre_cerrado_descripcion",
        label: "Descripción cuando cerraron las ventas",
        multiline: true,
      },
    ],
  },
