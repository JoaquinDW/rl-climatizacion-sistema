...
export async function POST(request: NextRequest) {
  try {
    ...
    // A propósito NO se valida el cierre de ventas acá: el pago ya se hizo.
    // Si alguien pagó 19:59 y vuelve del checkout 20:01, igual recibe sus
    // números. El corte se aplica en /api/crear-preferencia y /api/transferencia.
